...
@ArgsType()
class UpdateUserQuestionArgs {
  @Field(() => UserQuestionWhereUniqueInput, { nullable: false })
  where!: UserQuestionWhereUniqueInput;
  @Field(() => UserQuestionUpdateInput, { nullable: false })
  data!: UserQuestionUpdateInput;
}

export { UpdateUserQuestionArgs as UpdateUserQuestionArgs };
