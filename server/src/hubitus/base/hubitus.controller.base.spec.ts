...
describe("Hubitus", () => {
  ...
  test("GET /hubituses/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/hubituses"}/${nonExistingId}`)
  ...
  test("GET /hubituses/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/hubituses"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /hubituses existing resource", async () => {
