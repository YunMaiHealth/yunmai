...
@InputType()
class EventLogUpdateManyWithoutMessageNotifiesInput {
...
export { EventLogUpdateManyWithoutMessageNotifiesInput as EventLogUpdateManyWithoutMessageNotifiesInput };
