...
@InputType()
class EventLogCreateNestedManyWithoutMessageNotifiesInput {
...
export { EventLogCreateNestedManyWithoutMessageNotifiesInput as EventLogCreateNestedManyWithoutMessageNotifiesInput };
