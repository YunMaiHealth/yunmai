...
@ArgsType()
class UpdateHabitusArgs {
  @Field(() => HabitusWhereUniqueInput, { nullable: false })
  where!: HabitusWhereUniqueInput;
  @Field(() => HabitusUpdateInput, { nullable: false })
  data!: HabitusUpdateInput;
}

export { UpdateHabitusArgs as UpdateHabitusArgs };
