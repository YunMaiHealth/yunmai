...
describe("Habitus", () => {
  ...
  test("GET /habituses/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/habituses"}/${nonExistingId}`)
  ...
  test("GET /habituses/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/habituses"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /habituses existing resource", async () => {
