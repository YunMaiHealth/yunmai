...
@ArgsType()
class UpdateExpenseMataGasArgs {
  @Field(() => ExpenseMataGasWhereUniqueInput, { nullable: false })
  where!: ExpenseMataGasWhereUniqueInput;
  @Field(() => ExpenseMataGasUpdateInput, { nullable: false })
  data!: ExpenseMataGasUpdateInput;
}

export { UpdateExpenseMataGasArgs as UpdateExpenseMataGasArgs };
