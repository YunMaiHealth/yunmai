...
@InputType()
class MessageNotifyCreateNestedManyWithoutEventLogsInput {
...
export { MessageNotifyCreateNestedManyWithoutEventLogsInput as MessageNotifyCreateNestedManyWithoutEventLogsInput };
